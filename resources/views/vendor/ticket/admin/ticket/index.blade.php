    ...
    <div id='ticket-ticket-entry'>
        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                    ...
                    <span class="actions">
                    <!--   
                    <a  class="btn btn-xs btn-purple"  href="{!!guard_url('ticket/ticket/reports')!!}"><i class="fa fa-bar-chart" aria-hidden="true"></i><span class="hidden-sm hidden-xs"> Reports</span></a>
                    @include('ticket::admin.ticket.partial.actions')
                    -->

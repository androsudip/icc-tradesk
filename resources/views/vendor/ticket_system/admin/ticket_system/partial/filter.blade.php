<div class="btn-group ticket_system-ticket_system">
...
<div class="container-fluid">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[bus_id]" class="col-sm-2 control-label">
                                        {!! trans('ticket_system::ticket_system.label.bus_id')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[bus_id]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[journey_date]" class="col-sm-2 control-label">
                                        {!! trans('ticket_system::ticket_system.label.journey_date')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[journey_date]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[ticket_seats]" class="col-sm-2 control-label">
                                        {!! trans('ticket_system::ticket_system.label.ticket_seats')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[ticket_seats]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
...
$(document).ready(function(){
    ...
    $(".ticket_system-ticket_system .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/ticket_system.ticket_system.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".ticket_system-ticket_system .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.ticket_system-ticket_system .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'ticket_system.ticket_system.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#ticket_system-ticket_system-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#ticket_system-ticket_system-list .btn-reset-filter').css('display', 'none');

        ...
        <div class="modal-content">
            ...
            <div class="modal-body clearfix">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col3 manage-column">
                    ...
                    ->checkboxes(trans('ticket_system::ticket_system.cloumns'))
                    ->inline()
                    ->raw()!!}
...
<script type="text/javascript">
    ...
    $("#save_columns_settings").click(function(){
        ...
        formData.append('key', 'ticket_system.ticket_system.column');
        formData.append('package', 'TicketSystem');
        formData.append('module', 'TicketSystem');
